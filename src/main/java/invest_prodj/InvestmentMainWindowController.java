...
public class InvestmentMainWindowController implements Initializable {
    ...
    public void change_window_to_investment(ActionEvent e) throws IOException {
        root = FXMLLoader.load(InvestmentWindowController.class.getResource("investment_window.fxml"));
        stage = (Stage)((Node)e.getSource()).getScene().getWindow();
        scene = new Scene(root);
    ...
    public void sound_naruto(MouseEvent event){
        String path = "src/main/resources/invest_prodj/sounds/naruto.mp3";
        Media media = new Media(Paths.get(path).toUri().toString());
        mediaPlayer = new MediaPlayer(media);
        mediaPlayer.play();
    }

    public void sound_sasuke(MouseEvent event){
        String path = "src/main/resources/invest_prodj/sounds/sasuke.mp3";
        Media media = new Media(Paths.get(path).toUri().toString());
        mediaPlayer = new MediaPlayer(media);
        mediaPlayer.play();
    }
